...
const HowToUse = () => {
    return (
        <div id="how-to-use-container">
            <h2>How To Use</h2>
            <p>Create a new account by clicking the 'Signup' button on the home page. Choose a unique username and create a password.</p>
            <p>You'll then be forwarded to the habit list page once you're logged in.</p>
            ...
            <p><em>For example,</em> you might want to do a 30 minute bike ride 5 out of the next 10 days.</p>
            ...
            <p>A habit will display 'Completed' when you have logged the amount of days you set as a goal or 'Failed' if the amount of days you set to reach your goal has reached zero.</p>
            <Link to='/'>
